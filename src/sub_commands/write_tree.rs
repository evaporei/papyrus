...
fn execute_successfully() {
    ...
    fs.write_file(&index_path, &[68, 73, 82, 67, 0, 0, 0, 2, 0, 0, 0, 1, 94, 220, 132, 142, 0, 0, 0, 0, 94, 220, 132, 142, 0, 0, 0, 0, 1, 0, 0, 4, 1, 72, 83, 202, 0, 0, 129, 164, 0, 0, 1, 245, 0, 0, 0, 20, 0, 0, 1, 23, 22, 168, 14, 57, 131, 236, 189, 112, 58, 63, 67, 88, 88, 140, 254, 8, 213, 33, 154, 44, 0, 10, 67, 97, 114, 103, 111, 46, 116, 111, 109, 108, 0, 0, 0, 0, 0, 0, 0, 0, 221, 161, 67, 7, 244, 26, 34, 221, 145, 12, 6, 131, 203, 40, 226, 145, 244, 89, 40, 157]);

    assert_eq!(execute(&mut fs).unwrap(), "7d11a85a54c02af57434e2bcd5ea7d7ea303e4ac");
    ...
    assert_eq!(
        ...
        vec![120, 156, 1, 46, 0, 209, 255, 116, 114, 101, 101, 32, 51, 56, 0, 49, 48, 48, 54, 52, 52, 32, 67, 97, 114, 103, 111, 46, 116, 111, 109, 108, 0, 22, 168, 14, 57, 131, 236, 189, 112, 58, 63, 67, 88, 88, 140, 254, 8, 213, 33, 154, 44, 74, 83, 15, 188]
    );
}
